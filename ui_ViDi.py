...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/Actions/pictures/change-slice.svg")), QtGui.QIcon.Active, QtGui.QIcon.On)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(_fromUtf8(":/Actions/pictures/dosimetry.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_dosimetry.setIcon(icon16)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(_fromUtf8(":/Actions/pictures/clone-rois.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_clone_rois.setIcon(icon17)
        self.act_clone_rois.setObjectName(_fromUtf8("act_clone_rois"))
        self.act_phantom = QtGui.QAction(MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(_fromUtf8(":/Actions/pictures/phantom.svg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.act_phantom.setIcon(icon18)
        self.act_phantom.setObjectName(_fromUtf8("act_phantom"))
        self.tb_files.addAction(self.act_open_file)
        self.tb_files.addSeparator()
        self.tb_files.addAction(self.act_tools)
        self.tb_files.addSeparator()
        self.tb_files.addAction(self.act_settings)
        self.tb_files.addSeparator()
        self.tb_files.addAction(self.actExit)
        self.tb_edit.addAction(self.act_show_info)
        self.tb_edit.addAction(self.act_zoom)
        self.tb_edit.addSeparator()
        self.tb_edit.addAction(self.act_roi_auto)
        self.tb_edit.addAction(self.act_roi_pol)
        self.tb_edit.addAction(self.act_roi_circ)
        self.tb_edit.addAction(self.act_clone_rois)
        self.tb_edit.addAction(self.act_get_stats)
        self.tb_tools.addAction(self.act_dosimetry)
        self.tb_tools.addAction(self.act_phantom)
